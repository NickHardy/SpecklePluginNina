...
namespace NINA.Plugin.Speckle.Sequencer.Container {
    ...
    public class TargetContainer : SequenceContainer, IDeepSkyObjectContainer, ICameraConsumer {
        ...
        public override object Clone() {
            var clone = new TargetContainer(profileService, cameraMediator, nighttimeCalculator, framingAssistantVM, applicationMediator, planetariumFactory) {
                Icon = Icon,
                Name = Name,
                Category = Category,
