...
namespace NINA.Plugin.Speckle.Sequencer.SequenceItem {
    ...
    public class TakeSingleExposure : NINA.Sequencer.SequenceItem.SequenceItem, IExposureItem, IValidatable {
        ...
        public TakeSingleExposure(IProfileService profileService, ICameraMediator cameraMediator, ITelescopeMediator telescopeMediator, ISpeckleOptionsProvider optionsProvider, ISpeckleAcquisitionService acquisitionService) {
            Gain = -1;
            Offset = -1;
        ...
        private TakeSingleExposure(TakeSingleExposure cloneMe) : this(cloneMe.profileService, cloneMe.cameraMediator, cloneMe.telescopeMediator, cloneMe.optionsProvider, cloneMe.acquisitionService) {
