...
namespace NINA.Plugin.Speckle.Sequencer.SequenceItem {
    ...
    public class CenterOnStarCluster : NINA.Sequencer.SequenceItem.SequenceItem, IValidatable {
        ...
        public CenterOnStarCluster(ITelescopeMediator telescopeMediator,
        ...
        private CenterOnStarCluster(CenterOnStarCluster cloneMe) : this(cloneMe.telescopeMediator,
        ...
        private ClusterCenteringRequest BuildRequest() {
            var speckleTarget = Utility.ItemUtility.RetrieveSpeckleTarget(Parent);
            return new ClusterCenteringRequest {
                Mode = ClusterCenteringMode.Center,
                ...
                ClusterSelected = selection => {
                    ...
                    if (Platesolve && speckleTarget != null) {
        ...
        public override async Task Execute(IProgress<ApplicationStatus> progress, CancellationToken token) {
            ...
            if (Platesolve) {
                ...
                await clusterCenteringService.CenterViaStarClusterAsync(request, progress, null, token);
            }
        }
